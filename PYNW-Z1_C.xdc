...
## Modified from the PYNQ github by Ryan Williams
## @Date 02/01/2019r1
## -----------------------------------------------------------------------------
...
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { pynq_led[2] }]; #IO_L21N_T3_DQS_AD14N_35 Sch=led[2]
